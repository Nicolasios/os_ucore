...
main(void) {
  ...
  800fab:	66 b8 28 00          	mov    $0x28,%ax
  800faf:	8e d8                	mov    %eax,%ds
    panic("FAIL: T.T\n");
  800fb1:	83 ec 04             	sub    $0x4,%esp
  800fb4:	68 c0 12 80 00       	push   $0x8012c0
  800fb9:	6a 09                	push   $0x9
  800fbb:	68 cb 12 80 00       	push   $0x8012cb
  800fc0:	e8 5b f0 ff ff       	call   800020 <__panic>
