...
main(void) {
  ...
  800fae:	68 a0 13 80 00       	push   $0x8013a0
  ...
  800fc7:	75 12                	jne    800fdb <main+0x45>
        cprintf("I am the child. spinning ...\n");
  800fc9:	83 ec 0c             	sub    $0xc,%esp
  800fcc:	68 c7 13 80 00       	push   $0x8013c7
  800fd1:	e8 0a f3 ff ff       	call   8002e0 <cprintf>
  800fd6:	83 c4 10             	add    $0x10,%esp
        while (1);
  800fd9:	eb fe                	jmp    800fd9 <main+0x43>
    }
    cprintf("I am the parent. Running the child...\n");
  800fdb:	83 ec 0c             	sub    $0xc,%esp
  800fde:	68 e8 13 80 00       	push   $0x8013e8
  800fe3:	e8 f8 f2 ff ff       	call   8002e0 <cprintf>
  800fe8:	83 c4 10             	add    $0x10,%esp

    yield();
  800feb:	e8 3d f2 ff ff       	call   80022d <yield>
    yield();
  800ff0:	e8 38 f2 ff ff       	call   80022d <yield>
    yield();
  800ff5:	e8 33 f2 ff ff       	call   80022d <yield>

    cprintf("I am the parent.  Killing the child...\n");
  800ffa:	83 ec 0c             	sub    $0xc,%esp
  800ffd:	68 10 14 80 00       	push   $0x801410
  801002:	e8 d9 f2 ff ff       	call   8002e0 <cprintf>
  801007:	83 c4 10             	add    $0x10,%esp

    assert((ret = kill(pid)) == 0);
  80100a:	83 ec 0c             	sub    $0xc,%esp
  80100d:	ff 75 f4             	pushl  -0xc(%ebp)
  801010:	e8 2a f2 ff ff       	call   80023f <kill>
  801015:	83 c4 10             	add    $0x10,%esp
  801018:	89 45 f0             	mov    %eax,-0x10(%ebp)
  80101b:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
  80101f:	74 16                	je     801037 <main+0xa1>
  801021:	68 38 14 80 00       	push   $0x801438
  801026:	68 4f 14 80 00       	push   $0x80144f
  80102b:	6a 14                	push   $0x14
  80102d:	68 64 14 80 00       	push   $0x801464
  801032:	e8 e9 ef ff ff       	call   800020 <__panic>
    cprintf("kill returns %d\n", ret);
  801037:	83 ec 08             	sub    $0x8,%esp
  80103a:	ff 75 f0             	pushl  -0x10(%ebp)
  80103d:	68 70 14 80 00       	push   $0x801470
  801042:	e8 99 f2 ff ff       	call   8002e0 <cprintf>
  ...
  801052:	e8 b9 f1 ff ff       	call   800210 <waitpid>
  801057:	83 c4 10             	add    $0x10,%esp
  80105a:	89 45 f0             	mov    %eax,-0x10(%ebp)
  80105d:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
  801061:	74 16                	je     801079 <main+0xe3>
  801063:	68 84 14 80 00       	push   $0x801484
  801068:	68 4f 14 80 00       	push   $0x80144f
  80106d:	6a 17                	push   $0x17
  80106f:	68 64 14 80 00       	push   $0x801464
  801074:	e8 a7 ef ff ff       	call   800020 <__panic>
    cprintf("wait returns %d\n", ret);
  801079:	83 ec 08             	sub    $0x8,%esp
  80107c:	ff 75 f0             	pushl  -0x10(%ebp)
  80107f:	68 a4 14 80 00       	push   $0x8014a4
  801084:	e8 57 f2 ff ff       	call   8002e0 <cprintf>
  801089:	83 c4 10             	add    $0x10,%esp

    cprintf("spin may pass.\n");
  80108c:	83 ec 0c             	sub    $0xc,%esp
  80108f:	68 b5 14 80 00       	push   $0x8014b5
  801094:	e8 47 f2 ff ff       	call   8002e0 <cprintf>
  ...
  8010a4:	c9                   	leave  
  8010a5:	8d 61 fc             	lea    -0x4(%ecx),%esp
  8010a8:	c3                   	ret    
