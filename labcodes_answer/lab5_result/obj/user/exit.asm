...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800039:	68 00 11 80 00       	push   $0x801100
  ...
  80005b:	68 1a 11 80 00       	push   $0x80111a
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80008b:	68 1c 11 80 00       	push   $0x80111c
  ...
  8000ad:	68 1a 11 80 00       	push   $0x80111a
...
exit(int error_code) {
  ...
  8001d5:	68 38 11 80 00       	push   $0x801138
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800938:	05 64 12 80 00       	add    $0x801264,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800a8d:	8b 04 85 88 12 80 00 	mov    0x801288(,%eax,4),%eax
  ...
  800b6b:	53                   	push   %ebx
  800b6c:	68 75 12 80 00       	push   $0x801275
  ...
  800b7f:	e9 37 02 00 00       	jmp    800dbb <vprintfmt+0x3a0>
                printfmt(putch, putdat, "%s", p);
  800b84:	56                   	push   %esi
  800b85:	68 7e 12 80 00       	push   $0x80127e
  ...
  800baa:	75 05                	jne    800bb1 <vprintfmt+0x196>
                p = "(null)";
  800bac:	be 81 12 80 00       	mov    $0x801281,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  800fae:	68 e0 13 80 00       	push   $0x8013e0
  800fb3:	e8 28 f3 ff ff       	call   8002e0 <cprintf>
  800fb8:	83 c4 10             	add    $0x10,%esp
    if ((pid = fork()) == 0) {
  800fbb:	e8 24 f2 ff ff       	call   8001e4 <fork>
  800fc0:	89 45 f4             	mov    %eax,-0xc(%ebp)
  800fc3:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
  800fc7:	75 41                	jne    80100a <main+0x74>
        cprintf("I am the child.\n");
  800fc9:	83 ec 0c             	sub    $0xc,%esp
  800fcc:	68 07 14 80 00       	push   $0x801407
  800fd1:	e8 0a f3 ff ff       	call   8002e0 <cprintf>
  800fd6:	83 c4 10             	add    $0x10,%esp
        yield();
  800fd9:	e8 4f f2 ff ff       	call   80022d <yield>
        yield();
  800fde:	e8 4a f2 ff ff       	call   80022d <yield>
        yield();
  800fe3:	e8 45 f2 ff ff       	call   80022d <yield>
        yield();
  800fe8:	e8 40 f2 ff ff       	call   80022d <yield>
        yield();
  800fed:	e8 3b f2 ff ff       	call   80022d <yield>
        yield();
  800ff2:	e8 36 f2 ff ff       	call   80022d <yield>
        yield();
  800ff7:	e8 31 f2 ff ff       	call   80022d <yield>
        exit(magic);
  800ffc:	a1 08 20 80 00       	mov    0x802008,%eax
  801001:	83 ec 0c             	sub    $0xc,%esp
  801004:	50                   	push   %eax
  801005:	e8 b0 f1 ff ff       	call   8001ba <exit>
    }
    else {
        cprintf("I am parent, fork a child pid %d\n",pid);
  80100a:	83 ec 08             	sub    $0x8,%esp
  80100d:	ff 75 f4             	pushl  -0xc(%ebp)
  801010:	68 18 14 80 00       	push   $0x801418
  801015:	e8 c6 f2 ff ff       	call   8002e0 <cprintf>
  80101a:	83 c4 10             	add    $0x10,%esp
    }
    assert(pid > 0);
  80101d:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
  801021:	7f 16                	jg     801039 <main+0xa3>
  801023:	68 3a 14 80 00       	push   $0x80143a
  801028:	68 42 14 80 00       	push   $0x801442
  80102d:	6a 18                	push   $0x18
  80102f:	68 57 14 80 00       	push   $0x801457
  801034:	e8 e7 ef ff ff       	call   800020 <__panic>
    cprintf("I am the parent, waiting now..\n");
  801039:	83 ec 0c             	sub    $0xc,%esp
  80103c:	68 64 14 80 00       	push   $0x801464
  801041:	e8 9a f2 ff ff       	call   8002e0 <cprintf>
  ...
  801053:	e8 b8 f1 ff ff       	call   800210 <waitpid>
  801058:	83 c4 10             	add    $0x10,%esp
  80105b:	85 c0                	test   %eax,%eax
  80105d:	75 0c                	jne    80106b <main+0xd5>
  80105f:	8b 55 f0             	mov    -0x10(%ebp),%edx
  801062:	a1 08 20 80 00       	mov    0x802008,%eax
  801067:	39 c2                	cmp    %eax,%edx
  801069:	74 16                	je     801081 <main+0xeb>
  80106b:	68 84 14 80 00       	push   $0x801484
  801070:	68 42 14 80 00       	push   $0x801442
  801075:	6a 1b                	push   $0x1b
  801077:	68 57 14 80 00       	push   $0x801457
  80107c:	e8 9f ef ff ff       	call   800020 <__panic>
    assert(waitpid(pid, &code) != 0 && wait() != 0);
  801081:	83 ec 08             	sub    $0x8,%esp
  801084:	8d 45 f0             	lea    -0x10(%ebp),%eax
  801087:	50                   	push   %eax
  801088:	ff 75 f4             	pushl  -0xc(%ebp)
  80108b:	e8 80 f1 ff ff       	call   800210 <waitpid>
  801090:	83 c4 10             	add    $0x10,%esp
  801093:	85 c0                	test   %eax,%eax
  801095:	74 09                	je     8010a0 <main+0x10a>
  801097:	e8 59 f1 ff ff       	call   8001f5 <wait>
  80109c:	85 c0                	test   %eax,%eax
  80109e:	75 16                	jne    8010b6 <main+0x120>
  8010a0:	68 b0 14 80 00       	push   $0x8014b0
  8010a5:	68 42 14 80 00       	push   $0x801442
  8010aa:	6a 1c                	push   $0x1c
  8010ac:	68 57 14 80 00       	push   $0x801457
  8010b1:	e8 6a ef ff ff       	call   800020 <__panic>
    cprintf("waitpid %d ok.\n", pid);
  8010b6:	83 ec 08             	sub    $0x8,%esp
  8010b9:	ff 75 f4             	pushl  -0xc(%ebp)
  8010bc:	68 d8 14 80 00       	push   $0x8014d8
  8010c1:	e8 1a f2 ff ff       	call   8002e0 <cprintf>
  8010c6:	83 c4 10             	add    $0x10,%esp

    cprintf("exit pass.\n");
  8010c9:	83 ec 0c             	sub    $0xc,%esp
  8010cc:	68 e8 14 80 00       	push   $0x8014e8
  8010d1:	e8 0a f2 ff ff       	call   8002e0 <cprintf>
  ...
  8010e1:	c9                   	leave  
  8010e2:	8d 61 fc             	lea    -0x4(%ecx),%esp
  8010e5:	c3                   	ret    
