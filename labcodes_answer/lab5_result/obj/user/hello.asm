...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80005b:	68 1a 10 80 00       	push   $0x80101a
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80008b:	68 1c 10 80 00       	push   $0x80101c
  ...
  8000ad:	68 1a 10 80 00       	push   $0x80101a
...
exit(int error_code) {
  ...
  8001d5:	68 38 10 80 00       	push   $0x801038
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800938:	05 64 11 80 00       	add    $0x801164,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800a8d:	8b 04 85 88 11 80 00 	mov    0x801188(,%eax,4),%eax
  ...
  800b6b:	53                   	push   %ebx
  800b6c:	68 75 11 80 00       	push   $0x801175
  ...
  800b7f:	e9 37 02 00 00       	jmp    800dbb <vprintfmt+0x3a0>
                printfmt(putch, putdat, "%s", p);
  800b84:	56                   	push   %esi
  800b85:	68 7e 11 80 00       	push   $0x80117e
  ...
  800baa:	75 05                	jne    800bb1 <vprintfmt+0x196>
                p = "(null)";
  800bac:	be 81 11 80 00       	mov    $0x801181,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  800fae:	68 e0 12 80 00       	push   $0x8012e0
  800fb3:	e8 28 f3 ff ff       	call   8002e0 <cprintf>
  800fb8:	83 c4 10             	add    $0x10,%esp
    cprintf("I am process %d.\n", getpid());
  800fbb:	e8 99 f2 ff ff       	call   800259 <getpid>
  800fc0:	83 ec 08             	sub    $0x8,%esp
  800fc3:	50                   	push   %eax
  800fc4:	68 f0 12 80 00       	push   $0x8012f0
  800fc9:	e8 12 f3 ff ff       	call   8002e0 <cprintf>
  800fce:	83 c4 10             	add    $0x10,%esp
    cprintf("hello pass.\n");
  800fd1:	83 ec 0c             	sub    $0xc,%esp
  800fd4:	68 02 13 80 00       	push   $0x801302
  800fd9:	e8 02 f3 ff ff       	call   8002e0 <cprintf>
  ...
  800fe9:	c9                   	leave  
  800fea:	8d 61 fc             	lea    -0x4(%ecx),%esp
  800fed:	c3                   	ret    
