...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80005b:	68 5a 11 80 00       	push   $0x80115a
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80008b:	68 5c 11 80 00       	push   $0x80115c
  ...
  8000ad:	68 5a 11 80 00       	push   $0x80115a
...
exit(int error_code) {
  ...
  8001d5:	68 78 11 80 00       	push   $0x801178
...
umain(void) {
  ...
  800363:	83 ec 18             	sub    $0x18,%esp
    int ret = main();
  800366:	e8 f4 0c 00 00       	call   80105f <main>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800938:	05 a4 12 80 00       	add    $0x8012a4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800a8d:	8b 04 85 c8 12 80 00 	mov    0x8012c8(,%eax,4),%eax
  ...
  800b6b:	53                   	push   %ebx
  800b6c:	68 b5 12 80 00       	push   $0x8012b5
  ...
  800b7f:	e9 37 02 00 00       	jmp    800dbb <vprintfmt+0x3a0>
                printfmt(putch, putdat, "%s", p);
  800b84:	56                   	push   %esi
  800b85:	68 be 12 80 00       	push   $0x8012be
  ...
  800baa:	75 05                	jne    800bb1 <vprintfmt+0x196>
                p = "(null)";
  800bac:	be c1 12 80 00       	mov    $0x8012c1,%esi
            }
            if (width > 0 && padc != '-') {
...
do_yield(void) {
  ...
  800f9d:	83 ec 08             	sub    $0x8,%esp
    yield();
  800fa0:	e8 88 f2 ff ff       	call   80022d <yield>
    yield();
  800fa5:	e8 83 f2 ff ff       	call   80022d <yield>
    yield();
  800faa:	e8 7e f2 ff ff       	call   80022d <yield>
    yield();
  800faf:	e8 79 f2 ff ff       	call   80022d <yield>
    yield();
  800fb4:	e8 74 f2 ff ff       	call   80022d <yield>
    yield();
  800fb9:	e8 6f f2 ff ff       	call   80022d <yield>
}
  800fbe:	90                   	nop
  800fbf:	c9                   	leave  
  800fc0:	c3                   	ret    
...
loop(void) {
  ...
  800fce:	68 20 14 80 00       	push   $0x801420
  800fd3:	e8 08 f3 ff ff       	call   8002e0 <cprintf>
  800fd8:	83 c4 10             	add    $0x10,%esp
    while (1);
  800fdb:	eb fe                	jmp    800fdb <loop+0x1a>
...
work(void) {
  ...
  800fea:	68 2a 14 80 00       	push   $0x80142a
  800fef:	e8 ec f2 ff ff       	call   8002e0 <cprintf>
  800ff4:	83 c4 10             	add    $0x10,%esp
    do_yield();
  800ff7:	e8 9a ff ff ff       	call   800f96 <do_yield>
    if (kill(parent) == 0) {
  800ffc:	a1 08 20 80 00       	mov    0x802008,%eax
  801001:	83 ec 0c             	sub    $0xc,%esp
  801004:	50                   	push   %eax
  801005:	e8 35 f2 ff ff       	call   80023f <kill>
  80100a:	83 c4 10             	add    $0x10,%esp
  80100d:	85 c0                	test   %eax,%eax
  80100f:	75 44                	jne    801055 <work+0x78>
        cprintf("kill parent ok.\n");
  801011:	83 ec 0c             	sub    $0xc,%esp
  801014:	68 34 14 80 00       	push   $0x801434
  801019:	e8 c2 f2 ff ff       	call   8002e0 <cprintf>
  80101e:	83 c4 10             	add    $0x10,%esp
        do_yield();
  801021:	e8 70 ff ff ff       	call   800f96 <do_yield>
        if (kill(pid1) == 0) {
  801026:	a1 10 20 80 00       	mov    0x802010,%eax
  80102b:	83 ec 0c             	sub    $0xc,%esp
  80102e:	50                   	push   %eax
  80102f:	e8 0b f2 ff ff       	call   80023f <kill>
  801034:	83 c4 10             	add    $0x10,%esp
  801037:	85 c0                	test   %eax,%eax
  801039:	75 1a                	jne    801055 <work+0x78>
            cprintf("kill child1 ok.\n");
  80103b:	83 ec 0c             	sub    $0xc,%esp
  80103e:	68 45 14 80 00       	push   $0x801445
  801043:	e8 98 f2 ff ff       	call   8002e0 <cprintf>
  801048:	83 c4 10             	add    $0x10,%esp
            exit(0);
  80104b:	83 ec 0c             	sub    $0xc,%esp
  80104e:	6a 00                	push   $0x0
  801050:	e8 65 f1 ff ff       	call   8001ba <exit>
        }
    }
    exit(-1);
  801055:	83 ec 0c             	sub    $0xc,%esp
  801058:	6a ff                	push   $0xffffffff
  80105a:	e8 5b f1 ff ff       	call   8001ba <exit>
...
main(void) {
  ...
  801063:	8d 4c 24 04          	lea    0x4(%esp),%ecx
  801067:	83 e4 f0             	and    $0xfffffff0,%esp
  80106a:	ff 71 fc             	pushl  -0x4(%ecx)
  80106d:	55                   	push   %ebp
  80106e:	89 e5                	mov    %esp,%ebp
  801070:	51                   	push   %ecx
  801071:	83 ec 04             	sub    $0x4,%esp
    parent = getpid();
  801074:	e8 e0 f1 ff ff       	call   800259 <getpid>
  801079:	a3 08 20 80 00       	mov    %eax,0x802008
    if ((pid1 = fork()) == 0) {
  80107e:	e8 61 f1 ff ff       	call   8001e4 <fork>
  801083:	a3 10 20 80 00       	mov    %eax,0x802010
  801088:	a1 10 20 80 00       	mov    0x802010,%eax
  80108d:	85 c0                	test   %eax,%eax
  80108f:	75 05                	jne    801096 <main+0x37>
        loop();
  801091:	e8 2b ff ff ff       	call   800fc1 <loop>
    }

    assert(pid1 > 0);
  801096:	a1 10 20 80 00       	mov    0x802010,%eax
  80109b:	85 c0                	test   %eax,%eax
  80109d:	7f 16                	jg     8010b5 <main+0x56>
  80109f:	68 56 14 80 00       	push   $0x801456
  8010a4:	68 5f 14 80 00       	push   $0x80145f
  8010a9:	6a 2c                	push   $0x2c
  8010ab:	68 74 14 80 00       	push   $0x801474
  8010b0:	e8 6b ef ff ff       	call   800020 <__panic>

    if ((pid2 = fork()) == 0) {
  8010b5:	e8 2a f1 ff ff       	call   8001e4 <fork>
  8010ba:	a3 0c 20 80 00       	mov    %eax,0x80200c
  8010bf:	a1 0c 20 80 00       	mov    0x80200c,%eax
  8010c4:	85 c0                	test   %eax,%eax
  8010c6:	75 05                	jne    8010cd <main+0x6e>
        work();
  8010c8:	e8 10 ff ff ff       	call   800fdd <work>
    }
    if (pid2 > 0) {
  8010cd:	a1 0c 20 80 00       	mov    0x80200c,%eax
  8010d2:	85 c0                	test   %eax,%eax
  8010d4:	7e 3a                	jle    801110 <main+0xb1>
        cprintf("wait child 1.\n");
  8010d6:	83 ec 0c             	sub    $0xc,%esp
  8010d9:	68 84 14 80 00       	push   $0x801484
  8010de:	e8 fd f1 ff ff       	call   8002e0 <cprintf>
  8010e3:	83 c4 10             	add    $0x10,%esp
        waitpid(pid1, NULL);
  8010e6:	a1 10 20 80 00       	mov    0x802010,%eax
  8010eb:	83 ec 08             	sub    $0x8,%esp
  8010ee:	6a 00                	push   $0x0
  8010f0:	50                   	push   %eax
  8010f1:	e8 1a f1 ff ff       	call   800210 <waitpid>
  8010f6:	83 c4 10             	add    $0x10,%esp
        panic("waitpid %d returns\n", pid1);
  8010f9:	a1 10 20 80 00       	mov    0x802010,%eax
  8010fe:	50                   	push   %eax
  8010ff:	68 93 14 80 00       	push   $0x801493
  801104:	6a 34                	push   $0x34
  801106:	68 74 14 80 00       	push   $0x801474
  80110b:	e8 10 ef ff ff       	call   800020 <__panic>
    }
    else {
        kill(pid1);
  801110:	a1 10 20 80 00       	mov    0x802010,%eax
  801115:	83 ec 0c             	sub    $0xc,%esp
  801118:	50                   	push   %eax
  801119:	e8 21 f1 ff ff       	call   80023f <kill>
  80111e:	83 c4 10             	add    $0x10,%esp
    }
    panic("FAIL: T.T\n");
  801121:	83 ec 04             	sub    $0x4,%esp
  801124:	68 a7 14 80 00       	push   $0x8014a7
  801129:	6a 39                	push   $0x39
  80112b:	68 74 14 80 00       	push   $0x801474
  801130:	e8 eb ee ff ff       	call   800020 <__panic>
