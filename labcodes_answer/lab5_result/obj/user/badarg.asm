...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800039:	68 c0 10 80 00       	push   $0x8010c0
  ...
  80005b:	68 da 10 80 00       	push   $0x8010da
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80008b:	68 dc 10 80 00       	push   $0x8010dc
  ...
  8000ad:	68 da 10 80 00       	push   $0x8010da
...
exit(int error_code) {
  ...
  8001d5:	68 f8 10 80 00       	push   $0x8010f8
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800938:	05 24 12 80 00       	add    $0x801224,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800a8d:	8b 04 85 48 12 80 00 	mov    0x801248(,%eax,4),%eax
  ...
  800b60:	8b 34 9d c0 11 80 00 	mov    0x8011c0(,%ebx,4),%esi
  800b67:	85 f6                	test   %esi,%esi
  800b69:	75 19                	jne    800b84 <vprintfmt+0x169>
                printfmt(putch, putdat, "error %d", err);
  800b6b:	53                   	push   %ebx
  800b6c:	68 35 12 80 00       	push   $0x801235
  ...
  800b7f:	e9 37 02 00 00       	jmp    800dbb <vprintfmt+0x3a0>
                printfmt(putch, putdat, "%s", p);
  800b84:	56                   	push   %esi
  800b85:	68 3e 12 80 00       	push   $0x80123e
  ...
  800baa:	75 05                	jne    800bb1 <vprintfmt+0x196>
                p = "(null)";
  800bac:	be 41 12 80 00       	mov    $0x801241,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  800fa8:	83 ec 14             	sub    $0x14,%esp
    int pid, exit_code;
    if ((pid = fork()) == 0) {
  800fab:	e8 34 f2 ff ff       	call   8001e4 <fork>
  800fb0:	89 45 f0             	mov    %eax,-0x10(%ebp)
  800fb3:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
  800fb7:	75 35                	jne    800fee <main+0x58>
        cprintf("fork ok.\n");
  800fb9:	83 ec 0c             	sub    $0xc,%esp
  800fbc:	68 a0 13 80 00       	push   $0x8013a0
  800fc1:	e8 1a f3 ff ff       	call   8002e0 <cprintf>
  800fc6:	83 c4 10             	add    $0x10,%esp
        int i;
        for (i = 0; i < 10; i ++) {
  800fc9:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  800fd0:	eb 09                	jmp    800fdb <main+0x45>
            yield();
  800fd2:	e8 56 f2 ff ff       	call   80022d <yield>
        for (i = 0; i < 10; i ++) {
  800fd7:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  800fdb:	83 7d f4 09          	cmpl   $0x9,-0xc(%ebp)
  800fdf:	7e f1                	jle    800fd2 <main+0x3c>
        }
        exit(0xbeaf);
  800fe1:	83 ec 0c             	sub    $0xc,%esp
  800fe4:	68 af be 00 00       	push   $0xbeaf
  800fe9:	e8 cc f1 ff ff       	call   8001ba <exit>
    }
    assert(pid > 0);
  800fee:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
  800ff2:	7f 16                	jg     80100a <main+0x74>
  800ff4:	68 aa 13 80 00       	push   $0x8013aa
  800ff9:	68 b2 13 80 00       	push   $0x8013b2
  800ffe:	6a 0f                	push   $0xf
  801000:	68 c7 13 80 00       	push   $0x8013c7
  801005:	e8 16 f0 ff ff       	call   800020 <__panic>
    assert(waitpid(-1, NULL) != 0);
  80100a:	83 ec 08             	sub    $0x8,%esp
  80100d:	6a 00                	push   $0x0
  80100f:	6a ff                	push   $0xffffffff
  801011:	e8 fa f1 ff ff       	call   800210 <waitpid>
  801016:	83 c4 10             	add    $0x10,%esp
  801019:	85 c0                	test   %eax,%eax
  80101b:	75 16                	jne    801033 <main+0x9d>
  80101d:	68 d5 13 80 00       	push   $0x8013d5
  801022:	68 b2 13 80 00       	push   $0x8013b2
  801027:	6a 10                	push   $0x10
  801029:	68 c7 13 80 00       	push   $0x8013c7
  80102e:	e8 ed ef ff ff       	call   800020 <__panic>
    assert(waitpid(pid, (void *)0xC0000000) != 0);
  801033:	83 ec 08             	sub    $0x8,%esp
  801036:	68 00 00 00 c0       	push   $0xc0000000
  80103b:	ff 75 f0             	pushl  -0x10(%ebp)
  80103e:	e8 cd f1 ff ff       	call   800210 <waitpid>
  801043:	83 c4 10             	add    $0x10,%esp
  801046:	85 c0                	test   %eax,%eax
  801048:	75 16                	jne    801060 <main+0xca>
  80104a:	68 ec 13 80 00       	push   $0x8013ec
  80104f:	68 b2 13 80 00       	push   $0x8013b2
  801054:	6a 11                	push   $0x11
  801056:	68 c7 13 80 00       	push   $0x8013c7
  ...
  801066:	50                   	push   %eax
  801067:	ff 75 f0             	pushl  -0x10(%ebp)
  80106a:	e8 a1 f1 ff ff       	call   800210 <waitpid>
  80106f:	83 c4 10             	add    $0x10,%esp
  801072:	85 c0                	test   %eax,%eax
  801074:	75 0a                	jne    801080 <main+0xea>
  801076:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801079:	3d af be 00 00       	cmp    $0xbeaf,%eax
  80107e:	74 16                	je     801096 <main+0x100>
  801080:	68 14 14 80 00       	push   $0x801414
  801085:	68 b2 13 80 00       	push   $0x8013b2
  80108a:	6a 12                	push   $0x12
  80108c:	68 c7 13 80 00       	push   $0x8013c7
  801091:	e8 8a ef ff ff       	call   800020 <__panic>
    cprintf("badarg pass.\n");
  801096:	83 ec 0c             	sub    $0xc,%esp
  801099:	68 49 14 80 00       	push   $0x801449
  80109e:	e8 3d f2 ff ff       	call   8002e0 <cprintf>
  ...
  8010ae:	c9                   	leave  
  8010af:	8d 61 fc             	lea    -0x4(%ecx),%esp
  8010b2:	c3                   	ret    
