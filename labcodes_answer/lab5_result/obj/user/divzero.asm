...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80005b:	68 fa 0f 80 00       	push   $0x800ffa
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80008b:	68 fc 0f 80 00       	push   $0x800ffc
  ...
  8000ad:	68 fa 0f 80 00       	push   $0x800ffa
...
exit(int error_code) {
  ...
  8001d5:	68 18 10 80 00       	push   $0x801018
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800938:	05 44 11 80 00       	add    $0x801144,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800a8d:	8b 04 85 68 11 80 00 	mov    0x801168(,%eax,4),%eax
  ...
  800b60:	8b 34 9d e0 10 80 00 	mov    0x8010e0(,%ebx,4),%esi
  800b67:	85 f6                	test   %esi,%esi
  800b69:	75 19                	jne    800b84 <vprintfmt+0x169>
                printfmt(putch, putdat, "error %d", err);
  800b6b:	53                   	push   %ebx
  800b6c:	68 55 11 80 00       	push   $0x801155
  ...
  800b7f:	e9 37 02 00 00       	jmp    800dbb <vprintfmt+0x3a0>
                printfmt(putch, putdat, "%s", p);
  800b84:	56                   	push   %esi
  800b85:	68 5e 11 80 00       	push   $0x80115e
  ...
  800baa:	75 05                	jne    800bb1 <vprintfmt+0x196>
                p = "(null)";
  800bac:	be 61 11 80 00       	mov    $0x801161,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  800fa8:	83 ec 04             	sub    $0x4,%esp
    cprintf("value is %d.\n", 1 / zero);
  800fab:	8b 0d 08 20 80 00    	mov    0x802008,%ecx
  800fb1:	b8 01 00 00 00       	mov    $0x1,%eax
  800fb6:	99                   	cltd   
  800fb7:	f7 f9                	idiv   %ecx
  800fb9:	83 ec 08             	sub    $0x8,%esp
  800fbc:	50                   	push   %eax
  800fbd:	68 c0 12 80 00       	push   $0x8012c0
  800fc2:	e8 19 f3 ff ff       	call   8002e0 <cprintf>
  800fc7:	83 c4 10             	add    $0x10,%esp
    panic("FAIL: T.T\n");
  800fca:	83 ec 04             	sub    $0x4,%esp
  800fcd:	68 ce 12 80 00       	push   $0x8012ce
  800fd2:	6a 09                	push   $0x9
  800fd4:	68 d9 12 80 00       	push   $0x8012d9
  800fd9:	e8 42 f0 ff ff       	call   800020 <__panic>
