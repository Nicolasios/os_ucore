...
main(void) {
  ...
  800fab:	b8 00 00 c0 fa       	mov    $0xfac00000,%eax
  800fb0:	8b 00                	mov    (%eax),%eax
  800fb2:	83 ec 08             	sub    $0x8,%esp
  800fb5:	50                   	push   %eax
  800fb6:	68 c0 12 80 00       	push   $0x8012c0
  800fbb:	e8 20 f3 ff ff       	call   8002e0 <cprintf>
  800fc0:	83 c4 10             	add    $0x10,%esp
    panic("FAIL: T.T\n");
  800fc3:	83 ec 04             	sub    $0x4,%esp
  800fc6:	68 de 12 80 00       	push   $0x8012de
  800fcb:	6a 07                	push   $0x7
  800fcd:	68 e9 12 80 00       	push   $0x8012e9
  800fd2:	e8 49 f0 ff ff       	call   800020 <__panic>
