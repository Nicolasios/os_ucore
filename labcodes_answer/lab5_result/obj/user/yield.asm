...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80005b:	68 5a 10 80 00       	push   $0x80105a
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80008b:	68 5c 10 80 00       	push   $0x80105c
  ...
  8000ad:	68 5a 10 80 00       	push   $0x80105a
...
exit(int error_code) {
  ...
  8001d5:	68 78 10 80 00       	push   $0x801078
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800938:	05 a4 11 80 00       	add    $0x8011a4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800a8d:	8b 04 85 c8 11 80 00 	mov    0x8011c8(,%eax,4),%eax
  ...
  800b60:	8b 34 9d 40 11 80 00 	mov    0x801140(,%ebx,4),%esi
  800b67:	85 f6                	test   %esi,%esi
  800b69:	75 19                	jne    800b84 <vprintfmt+0x169>
                printfmt(putch, putdat, "error %d", err);
  800b6b:	53                   	push   %ebx
  800b6c:	68 b5 11 80 00       	push   $0x8011b5
  ...
  800b7f:	e9 37 02 00 00       	jmp    800dbb <vprintfmt+0x3a0>
                printfmt(putch, putdat, "%s", p);
  800b84:	56                   	push   %esi
  800b85:	68 be 11 80 00       	push   $0x8011be
  ...
  800baa:	75 05                	jne    800bb1 <vprintfmt+0x196>
                p = "(null)";
  800bac:	be c1 11 80 00       	mov    $0x8011c1,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  800fab:	e8 a9 f2 ff ff       	call   800259 <getpid>
  800fb0:	83 ec 08             	sub    $0x8,%esp
  800fb3:	50                   	push   %eax
  800fb4:	68 20 13 80 00       	push   $0x801320
  800fb9:	e8 22 f3 ff ff       	call   8002e0 <cprintf>
  800fbe:	83 c4 10             	add    $0x10,%esp
    for (i = 0; i < 5; i ++) {
  800fc1:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  800fc8:	eb 22                	jmp    800fec <main+0x56>
        yield();
  800fca:	e8 5e f2 ff ff       	call   80022d <yield>
        cprintf("Back in process %d, iteration %d.\n", getpid(), i);
  800fcf:	e8 85 f2 ff ff       	call   800259 <getpid>
  800fd4:	83 ec 04             	sub    $0x4,%esp
  800fd7:	ff 75 f4             	pushl  -0xc(%ebp)
  800fda:	50                   	push   %eax
  800fdb:	68 3c 13 80 00       	push   $0x80133c
  800fe0:	e8 fb f2 ff ff       	call   8002e0 <cprintf>
  800fe5:	83 c4 10             	add    $0x10,%esp
    for (i = 0; i < 5; i ++) {
  800fe8:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  800fec:	83 7d f4 04          	cmpl   $0x4,-0xc(%ebp)
  800ff0:	7e d8                	jle    800fca <main+0x34>
    }
    cprintf("All done in process %d.\n", getpid());
  800ff2:	e8 62 f2 ff ff       	call   800259 <getpid>
  800ff7:	83 ec 08             	sub    $0x8,%esp
  800ffa:	50                   	push   %eax
  800ffb:	68 5f 13 80 00       	push   $0x80135f
  801000:	e8 db f2 ff ff       	call   8002e0 <cprintf>
  801005:	83 c4 10             	add    $0x10,%esp
    cprintf("yield pass.\n");
  801008:	83 ec 0c             	sub    $0xc,%esp
  80100b:	68 78 13 80 00       	push   $0x801378
  801010:	e8 cb f2 ff ff       	call   8002e0 <cprintf>
  801015:	83 c4 10             	add    $0x10,%esp
    return 0;
  801018:	b8 00 00 00 00       	mov    $0x0,%eax
}
  80101d:	8b 4d fc             	mov    -0x4(%ebp),%ecx
  801020:	c9                   	leave  
  801021:	8d 61 fc             	lea    -0x4(%ecx),%esp
  801024:	c3                   	ret    
