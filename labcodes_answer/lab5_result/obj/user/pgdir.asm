...
main(void) {
  ...
  800fb3:	50                   	push   %eax
  800fb4:	68 e0 12 80 00       	push   $0x8012e0
  800fb9:	e8 22 f3 ff ff       	call   8002e0 <cprintf>
  800fbe:	83 c4 10             	add    $0x10,%esp
    print_pgdir();
  800fc1:	e8 a4 f2 ff ff       	call   80026a <print_pgdir>
    cprintf("pgdir pass.\n");
  800fc6:	83 ec 0c             	sub    $0xc,%esp
  800fc9:	68 f7 12 80 00       	push   $0x8012f7
  800fce:	e8 0d f3 ff ff       	call   8002e0 <cprintf>
  ...
  800fde:	c9                   	leave  
  800fdf:	8d 61 fc             	lea    -0x4(%ecx),%esp
  800fe2:	c3                   	ret    
