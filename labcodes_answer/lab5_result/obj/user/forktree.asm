...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800039:	68 80 10 80 00       	push   $0x801080
  ...
  80005b:	68 9a 10 80 00       	push   $0x80109a
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80008b:	68 9c 10 80 00       	push   $0x80109c
  ...
  8000ad:	68 9a 10 80 00       	push   $0x80109a
...
exit(int error_code) {
  ...
  8001d5:	68 b8 10 80 00       	push   $0x8010b8
...
umain(void) {
  ...
  800363:	83 ec 18             	sub    $0x18,%esp
    int ret = main();
  800366:	e8 dc 0c 00 00       	call   801047 <main>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800938:	05 e4 11 80 00       	add    $0x8011e4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800a8d:	8b 04 85 08 12 80 00 	mov    0x801208(,%eax,4),%eax
  ...
  800b60:	8b 34 9d 80 11 80 00 	mov    0x801180(,%ebx,4),%esi
  800b67:	85 f6                	test   %esi,%esi
  800b69:	75 19                	jne    800b84 <vprintfmt+0x169>
                printfmt(putch, putdat, "error %d", err);
  800b6b:	53                   	push   %ebx
  800b6c:	68 f5 11 80 00       	push   $0x8011f5
  ...
  800b7f:	e9 37 02 00 00       	jmp    800dbb <vprintfmt+0x3a0>
                printfmt(putch, putdat, "%s", p);
  800b84:	56                   	push   %esi
  800b85:	68 fe 11 80 00       	push   $0x8011fe
  ...
  800baa:	75 05                	jne    800bb1 <vprintfmt+0x196>
                p = "(null)";
  800bac:	be 01 12 80 00       	mov    $0x801201,%esi
            }
            if (width > 0 && padc != '-') {
...
forkchild(const char *cur, char branch) {
  ...
  800fa3:	88 45 e4             	mov    %al,-0x1c(%ebp)
    char nxt[DEPTH + 1];

    if (strlen(cur) >= DEPTH)
  800fa6:	83 ec 0c             	sub    $0xc,%esp
  800fa9:	ff 75 08             	pushl  0x8(%ebp)
  800fac:	e8 c8 f3 ff ff       	call   800379 <strlen>
  800fb1:	83 c4 10             	add    $0x10,%esp
  800fb4:	83 f8 03             	cmp    $0x3,%eax
  800fb7:	77 45                	ja     800ffe <forkchild+0x68>
        return;

    snprintf(nxt, DEPTH + 1, "%s%c", cur, branch);
  800fb9:	0f be 45 e4          	movsbl -0x1c(%ebp),%eax
  800fbd:	83 ec 0c             	sub    $0xc,%esp
  800fc0:	50                   	push   %eax
  800fc1:	ff 75 08             	pushl  0x8(%ebp)
  800fc4:	68 60 13 80 00       	push   $0x801360
  800fc9:	6a 05                	push   $0x5
  800fcb:	8d 45 f3             	lea    -0xd(%ebp),%eax
  800fce:	50                   	push   %eax
  800fcf:	e8 2e fe ff ff       	call   800e02 <snprintf>
  800fd4:	83 c4 20             	add    $0x20,%esp
    if (fork() == 0) {
  800fd7:	e8 08 f2 ff ff       	call   8001e4 <fork>
  800fdc:	85 c0                	test   %eax,%eax
  800fde:	75 1f                	jne    800fff <forkchild+0x69>
        forktree(nxt);
  800fe0:	83 ec 0c             	sub    $0xc,%esp
  800fe3:	8d 45 f3             	lea    -0xd(%ebp),%eax
  800fe6:	50                   	push   %eax
  800fe7:	e8 15 00 00 00       	call   801001 <forktree>
  800fec:	83 c4 10             	add    $0x10,%esp
        yield();
  800fef:	e8 39 f2 ff ff       	call   80022d <yield>
        exit(0);
  800ff4:	83 ec 0c             	sub    $0xc,%esp
  800ff7:	6a 00                	push   $0x0
  800ff9:	e8 bc f1 ff ff       	call   8001ba <exit>
        return;
  800ffe:	90                   	nop
    }
}
...
forktree(const char *cur) {
  ...
  801008:	83 ec 08             	sub    $0x8,%esp
    cprintf("%04x: I am '%s'\n", getpid(), cur);
  80100b:	e8 49 f2 ff ff       	call   800259 <getpid>
  801010:	83 ec 04             	sub    $0x4,%esp
  801013:	ff 75 08             	pushl  0x8(%ebp)
  801016:	50                   	push   %eax
  801017:	68 65 13 80 00       	push   $0x801365
  80101c:	e8 bf f2 ff ff       	call   8002e0 <cprintf>
  801021:	83 c4 10             	add    $0x10,%esp

    forkchild(cur, '0');
  801024:	83 ec 08             	sub    $0x8,%esp
  801027:	6a 30                	push   $0x30
  801029:	ff 75 08             	pushl  0x8(%ebp)
  80102c:	e8 65 ff ff ff       	call   800f96 <forkchild>
  801031:	83 c4 10             	add    $0x10,%esp
    forkchild(cur, '1');
  801034:	83 ec 08             	sub    $0x8,%esp
  801037:	6a 31                	push   $0x31
  801039:	ff 75 08             	pushl  0x8(%ebp)
  80103c:	e8 55 ff ff ff       	call   800f96 <forkchild>
...
main(void) {
  ...
  80104b:	8d 4c 24 04          	lea    0x4(%esp),%ecx
  80104f:	83 e4 f0             	and    $0xfffffff0,%esp
  801052:	ff 71 fc             	pushl  -0x4(%ecx)
  801055:	55                   	push   %ebp
  ...
  80105f:	68 76 13 80 00       	push   $0x801376
  801064:	e8 98 ff ff ff       	call   801001 <forktree>
  801069:	83 c4 10             	add    $0x10,%esp
    return 0;
  80106c:	b8 00 00 00 00       	mov    $0x0,%eax
}
  801071:	8b 4d fc             	mov    -0x4(%ebp),%ecx
  801074:	c9                   	leave  
  801075:	8d 61 fc             	lea    -0x4(%ecx),%esp
  801078:	c3                   	ret    
