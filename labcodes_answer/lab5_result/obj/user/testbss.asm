...
main(void) {
  ...
  800fae:	68 80 13 80 00       	push   $0x801380
  800fb3:	e8 28 f3 ff ff       	call   8002e0 <cprintf>
  800fb8:	83 c4 10             	add    $0x10,%esp
    int i;
    for (i = 0; i < ARRAYSIZE; i ++) {
  800fbb:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  800fc2:	eb 26                	jmp    800fea <main+0x54>
        if (bigarray[i] != 0) {
  800fc4:	8b 45 f4             	mov    -0xc(%ebp),%eax
  800fc7:	8b 04 85 20 20 80 00 	mov    0x802020(,%eax,4),%eax
  800fce:	85 c0                	test   %eax,%eax
  800fd0:	74 14                	je     800fe6 <main+0x50>
            panic("bigarray[%d] isn't cleared!\n", i);
  800fd2:	ff 75 f4             	pushl  -0xc(%ebp)
  800fd5:	68 a0 13 80 00       	push   $0x8013a0
  800fda:	6a 0e                	push   $0xe
  800fdc:	68 bd 13 80 00       	push   $0x8013bd
  800fe1:	e8 3a f0 ff ff       	call   800020 <__panic>
    for (i = 0; i < ARRAYSIZE; i ++) {
  800fe6:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  800fea:	81 7d f4 ff ff 0f 00 	cmpl   $0xfffff,-0xc(%ebp)
  800ff1:	7e d1                	jle    800fc4 <main+0x2e>
        }
    }
    for (i = 0; i < ARRAYSIZE; i ++) {
  800ff3:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  800ffa:	eb 11                	jmp    80100d <main+0x77>
        bigarray[i] = i;
  800ffc:	8b 55 f4             	mov    -0xc(%ebp),%edx
  800fff:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801002:	89 14 85 20 20 80 00 	mov    %edx,0x802020(,%eax,4)
    for (i = 0; i < ARRAYSIZE; i ++) {
  801009:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  80100d:	81 7d f4 ff ff 0f 00 	cmpl   $0xfffff,-0xc(%ebp)
  801014:	7e e6                	jle    800ffc <main+0x66>
    }
    for (i = 0; i < ARRAYSIZE; i ++) {
  801016:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  80101d:	eb 29                	jmp    801048 <main+0xb2>
        if (bigarray[i] != i) {
  80101f:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801022:	8b 14 85 20 20 80 00 	mov    0x802020(,%eax,4),%edx
  ...
  801033:	68 cc 13 80 00       	push   $0x8013cc
  801038:	6a 16                	push   $0x16
  80103a:	68 bd 13 80 00       	push   $0x8013bd
  80103f:	e8 dc ef ff ff       	call   800020 <__panic>
    for (i = 0; i < ARRAYSIZE; i ++) {
  801044:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
  801048:	81 7d f4 ff ff 0f 00 	cmpl   $0xfffff,-0xc(%ebp)
  80104f:	7e ce                	jle    80101f <main+0x89>
        }
    }

    cprintf("Yes, good.  Now doing a wild write off the end...\n");
  801051:	83 ec 0c             	sub    $0xc,%esp
  801054:	68 f4 13 80 00       	push   $0x8013f4
  801059:	e8 82 f2 ff ff       	call   8002e0 <cprintf>
  80105e:	83 c4 10             	add    $0x10,%esp
    cprintf("testbss may pass.\n");
  801061:	83 ec 0c             	sub    $0xc,%esp
  801064:	68 27 14 80 00       	push   $0x801427
  801069:	e8 72 f2 ff ff       	call   8002e0 <cprintf>
  80106e:	83 c4 10             	add    $0x10,%esp

    bigarray[ARRAYSIZE + 1024] = 0;
  801071:	c7 05 20 30 c0 00 00 	movl   $0x0,0xc03020
  801078:	00 00 00 
    asm volatile ("int $0x14");
  80107b:	cd 14                	int    $0x14
    panic("FAIL: T.T\n");
  80107d:	83 ec 04             	sub    $0x4,%esp
  801080:	68 3a 14 80 00       	push   $0x80143a
  801085:	6a 1f                	push   $0x1f
  801087:	68 bd 13 80 00       	push   $0x8013bd
  80108c:	e8 8f ef ff ff       	call   800020 <__panic>
