...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80003e:	c7 04 24 60 11 80 00 	movl   $0x801160,(%esp)
  ...
  800057:	e8 8d 02 00 00       	call   8002e9 <vcprintf>
    cprintf("\n");
  80005c:	c7 04 24 7a 11 80 00 	movl   $0x80117a,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  800092:	c7 04 24 7c 11 80 00 	movl   $0x80117c,(%esp)
  ...
  8000ab:	e8 39 02 00 00       	call   8002e9 <vcprintf>
    cprintf("\n");
  8000b0:	c7 04 24 7a 11 80 00 	movl   $0x80117a,(%esp)
...
exit(int error_code) {
  ...
  80020c:	c7 04 24 98 11 80 00 	movl   $0x801198,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80097a:	05 c4 12 80 00       	add    $0x8012c4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800ada:	8b 04 85 e8 12 80 00 	mov    0x8012e8(,%eax,4),%eax
  ...
  800bdd:	c7 44 24 08 de 12 80 	movl   $0x8012de,0x8(%esp)
  800be4:	00 
  ...
  800c09:	75 05                	jne    800c10 <vprintfmt+0x1a8>
                p = "(null)";
  800c0b:	be e1 12 80 00       	mov    $0x8012e1,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  801036:	c7 04 24 40 14 80 00 	movl   $0x801440,(%esp)
  80103d:	e8 de f2 ff ff       	call   800320 <cprintf>
    int i;
    for (i = 0; i < ARRAYSIZE; i ++) {
  801042:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  801049:	00 
  80104a:	eb 37                	jmp    801083 <main+0x5a>
        if (bigarray[i] != 0) {
  80104c:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801050:	8b 04 85 20 20 80 00 	mov    0x802020(,%eax,4),%eax
  801057:	85 c0                	test   %eax,%eax
  801059:	74 24                	je     80107f <main+0x56>
            panic("bigarray[%d] isn't cleared!\n", i);
  80105b:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80105f:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801063:	c7 44 24 08 60 14 80 	movl   $0x801460,0x8(%esp)
  80106a:	00 
  80106b:	c7 44 24 04 0e 00 00 	movl   $0xe,0x4(%esp)
  801072:	00 
  801073:	c7 04 24 7d 14 80 00 	movl   $0x80147d,(%esp)
  80107a:	e8 a1 ef ff ff       	call   800020 <__panic>
    for (i = 0; i < ARRAYSIZE; i ++) {
  80107f:	ff 44 24 1c          	incl   0x1c(%esp)
  801083:	81 7c 24 1c ff ff 0f 	cmpl   $0xfffff,0x1c(%esp)
  80108a:	00 
  80108b:	7e bf                	jle    80104c <main+0x23>
        }
    }
    for (i = 0; i < ARRAYSIZE; i ++) {
  80108d:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  801094:	00 
  801095:	eb 13                	jmp    8010aa <main+0x81>
        bigarray[i] = i;
  801097:	8b 54 24 1c          	mov    0x1c(%esp),%edx
  80109b:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80109f:	89 14 85 20 20 80 00 	mov    %edx,0x802020(,%eax,4)
    for (i = 0; i < ARRAYSIZE; i ++) {
  8010a6:	ff 44 24 1c          	incl   0x1c(%esp)
  8010aa:	81 7c 24 1c ff ff 0f 	cmpl   $0xfffff,0x1c(%esp)
  8010b1:	00 
  8010b2:	7e e3                	jle    801097 <main+0x6e>
    }
    for (i = 0; i < ARRAYSIZE; i ++) {
  8010b4:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  8010bb:	00 
  8010bc:	eb 3b                	jmp    8010f9 <main+0xd0>
        if (bigarray[i] != i) {
  8010be:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8010c2:	8b 14 85 20 20 80 00 	mov    0x802020(,%eax,4),%edx
  8010c9:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8010cd:	39 c2                	cmp    %eax,%edx
  8010cf:	74 24                	je     8010f5 <main+0xcc>
            panic("bigarray[%d] didn't hold its value!\n", i);
  8010d1:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8010d5:	89 44 24 0c          	mov    %eax,0xc(%esp)
  8010d9:	c7 44 24 08 8c 14 80 	movl   $0x80148c,0x8(%esp)
  8010e0:	00 
  8010e1:	c7 44 24 04 16 00 00 	movl   $0x16,0x4(%esp)
  8010e8:	00 
  8010e9:	c7 04 24 7d 14 80 00 	movl   $0x80147d,(%esp)
  8010f0:	e8 2b ef ff ff       	call   800020 <__panic>
    for (i = 0; i < ARRAYSIZE; i ++) {
  8010f5:	ff 44 24 1c          	incl   0x1c(%esp)
  8010f9:	81 7c 24 1c ff ff 0f 	cmpl   $0xfffff,0x1c(%esp)
  801100:	00 
  801101:	7e bb                	jle    8010be <main+0x95>
        }
    }

    cprintf("Yes, good.  Now doing a wild write off the end...\n");
  801103:	c7 04 24 b4 14 80 00 	movl   $0x8014b4,(%esp)
  80110a:	e8 11 f2 ff ff       	call   800320 <cprintf>
    cprintf("testbss may pass.\n");
  80110f:	c7 04 24 e7 14 80 00 	movl   $0x8014e7,(%esp)
  801116:	e8 05 f2 ff ff       	call   800320 <cprintf>

    bigarray[ARRAYSIZE + 1024] = 0;
  80111b:	c7 05 20 30 c0 00 00 	movl   $0x0,0xc03020
  801122:	00 00 00 
    asm volatile ("int $0x14");
  801125:	cd 14                	int    $0x14
    panic("FAIL: T.T\n");
  801127:	c7 44 24 08 fa 14 80 	movl   $0x8014fa,0x8(%esp)
  80112e:	00 
  80112f:	c7 44 24 04 1f 00 00 	movl   $0x1f,0x4(%esp)
  801136:	00 
  801137:	c7 04 24 7d 14 80 00 	movl   $0x80147d,(%esp)
  80113e:	e8 dd ee ff ff       	call   800020 <__panic>
