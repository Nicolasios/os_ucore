...
main(void) {
  ...
  801036:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  80103d:	00 
  80103e:	eb 5f                	jmp    80109f <main+0x76>
        if ((pid = fork()) == 0) {
  801040:	e8 d5 f1 ff ff       	call   80021a <fork>
  801045:	89 44 24 18          	mov    %eax,0x18(%esp)
  801049:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  80104e:	75 20                	jne    801070 <main+0x47>
            cprintf("I am child %d\n", n);
  801050:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801054:	89 44 24 04          	mov    %eax,0x4(%esp)
  801058:	c7 04 24 44 14 80 00 	movl   $0x801444,(%esp)
  80105f:	e8 bc f2 ff ff       	call   800320 <cprintf>
            exit(0);
  801064:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  80106b:	e8 87 f1 ff ff       	call   8001f7 <exit>
        }
        assert(pid > 0);
  801070:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  801075:	7f 24                	jg     80109b <main+0x72>
  801077:	c7 44 24 0c 53 14 80 	movl   $0x801453,0xc(%esp)
  80107e:	00 
  80107f:	c7 44 24 08 5b 14 80 	movl   $0x80145b,0x8(%esp)
  801086:	00 
  801087:	c7 44 24 04 0e 00 00 	movl   $0xe,0x4(%esp)
  80108e:	00 
  80108f:	c7 04 24 70 14 80 00 	movl   $0x801470,(%esp)
  801096:	e8 85 ef ff ff       	call   800020 <__panic>
    for (n = 0; n < max_child; n ++) {
  80109b:	ff 44 24 1c          	incl   0x1c(%esp)
  80109f:	b8 20 00 00 00       	mov    $0x20,%eax
  8010a4:	39 44 24 1c          	cmp    %eax,0x1c(%esp)
  8010a8:	7c 96                	jl     801040 <main+0x17>
    }

    if (n > max_child) {
  8010aa:	b8 20 00 00 00       	mov    $0x20,%eax
  8010af:	39 44 24 1c          	cmp    %eax,0x1c(%esp)
  8010b3:	7e 4d                	jle    801102 <main+0xd9>
        panic("fork claimed to work %d times!\n", n);
  8010b5:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8010b9:	89 44 24 0c          	mov    %eax,0xc(%esp)
  8010bd:	c7 44 24 08 80 14 80 	movl   $0x801480,0x8(%esp)
  8010c4:	00 
  8010c5:	c7 44 24 04 12 00 00 	movl   $0x12,0x4(%esp)
  8010cc:	00 
  8010cd:	c7 04 24 70 14 80 00 	movl   $0x801470,(%esp)
  8010d4:	e8 47 ef ff ff       	call   800020 <__panic>
    }

    for (; n > 0; n --) {
        if (wait() != 0) {
  8010d9:	e8 4d f1 ff ff       	call   80022b <wait>
  8010de:	85 c0                	test   %eax,%eax
  8010e0:	74 1c                	je     8010fe <main+0xd5>
            panic("wait stopped early\n");
  8010e2:	c7 44 24 08 a0 14 80 	movl   $0x8014a0,0x8(%esp)
  8010e9:	00 
  8010ea:	c7 44 24 04 17 00 00 	movl   $0x17,0x4(%esp)
  8010f1:	00 
  8010f2:	c7 04 24 70 14 80 00 	movl   $0x801470,(%esp)
  8010f9:	e8 22 ef ff ff       	call   800020 <__panic>
    for (; n > 0; n --) {
  8010fe:	ff 4c 24 1c          	decl   0x1c(%esp)
  801102:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  801107:	7f d0                	jg     8010d9 <main+0xb0>
        }
    }

    if (wait() == 0) {
  801109:	e8 1d f1 ff ff       	call   80022b <wait>
  80110e:	85 c0                	test   %eax,%eax
  801110:	75 1c                	jne    80112e <main+0x105>
        panic("wait got too many\n");
  801112:	c7 44 24 08 b4 14 80 	movl   $0x8014b4,0x8(%esp)
  801119:	00 
  80111a:	c7 44 24 04 1c 00 00 	movl   $0x1c,0x4(%esp)
  801121:	00 
  801122:	c7 04 24 70 14 80 00 	movl   $0x801470,(%esp)
  801129:	e8 f2 ee ff ff       	call   800020 <__panic>
    }

    cprintf("forktest pass.\n");
  80112e:	c7 04 24 c7 14 80 00 	movl   $0x8014c7,(%esp)
  801135:	e8 e6 f1 ff ff       	call   800320 <cprintf>
    return 0;
