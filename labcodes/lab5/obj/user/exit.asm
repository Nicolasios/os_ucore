...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80003e:	c7 04 24 a0 11 80 00 	movl   $0x8011a0,(%esp)
  ...
  800057:	e8 8d 02 00 00       	call   8002e9 <vcprintf>
    cprintf("\n");
  80005c:	c7 04 24 ba 11 80 00 	movl   $0x8011ba,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  800092:	c7 04 24 bc 11 80 00 	movl   $0x8011bc,(%esp)
  ...
  8000ab:	e8 39 02 00 00       	call   8002e9 <vcprintf>
    cprintf("\n");
  8000b0:	c7 04 24 ba 11 80 00 	movl   $0x8011ba,(%esp)
...
exit(int error_code) {
  ...
  80020c:	c7 04 24 d8 11 80 00 	movl   $0x8011d8,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80097a:	05 04 13 80 00       	add    $0x801304,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800ada:	8b 04 85 28 13 80 00 	mov    0x801328(,%eax,4),%eax
  ...
  800bdd:	c7 44 24 08 1e 13 80 	movl   $0x80131e,0x8(%esp)
  800be4:	00 
  ...
  800c09:	75 05                	jne    800c10 <vprintfmt+0x1a8>
                p = "(null)";
  800c0b:	be 21 13 80 00       	mov    $0x801321,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  801036:	c7 04 24 80 14 80 00 	movl   $0x801480,(%esp)
  80103d:	e8 de f2 ff ff       	call   800320 <cprintf>
    if ((pid = fork()) == 0) {
  801042:	e8 d3 f1 ff ff       	call   80021a <fork>
  801047:	89 44 24 1c          	mov    %eax,0x1c(%esp)
  80104b:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  801050:	75 3c                	jne    80108e <main+0x65>
        cprintf("I am the child.\n");
  801052:	c7 04 24 a7 14 80 00 	movl   $0x8014a7,(%esp)
  801059:	e8 c2 f2 ff ff       	call   800320 <cprintf>
        yield();
  80105e:	e8 06 f2 ff ff       	call   800269 <yield>
        yield();
  801063:	e8 01 f2 ff ff       	call   800269 <yield>
        yield();
  801068:	e8 fc f1 ff ff       	call   800269 <yield>
        yield();
  80106d:	e8 f7 f1 ff ff       	call   800269 <yield>
        yield();
  801072:	e8 f2 f1 ff ff       	call   800269 <yield>
        yield();
  801077:	e8 ed f1 ff ff       	call   800269 <yield>
        yield();
  80107c:	e8 e8 f1 ff ff       	call   800269 <yield>
        exit(magic);
  801081:	a1 08 20 80 00       	mov    0x802008,%eax
  801086:	89 04 24             	mov    %eax,(%esp)
  801089:	e8 69 f1 ff ff       	call   8001f7 <exit>
    }
    else {
        cprintf("I am parent, fork a child pid %d\n",pid);
  80108e:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  801092:	89 44 24 04          	mov    %eax,0x4(%esp)
  801096:	c7 04 24 b8 14 80 00 	movl   $0x8014b8,(%esp)
  80109d:	e8 7e f2 ff ff       	call   800320 <cprintf>
    }
    assert(pid > 0);
  8010a2:	83 7c 24 1c 00       	cmpl   $0x0,0x1c(%esp)
  8010a7:	7f 24                	jg     8010cd <main+0xa4>
  8010a9:	c7 44 24 0c da 14 80 	movl   $0x8014da,0xc(%esp)
  8010b0:	00 
  8010b1:	c7 44 24 08 e2 14 80 	movl   $0x8014e2,0x8(%esp)
  8010b8:	00 
  8010b9:	c7 44 24 04 18 00 00 	movl   $0x18,0x4(%esp)
  8010c0:	00 
  8010c1:	c7 04 24 f7 14 80 00 	movl   $0x8014f7,(%esp)
  8010c8:	e8 53 ef ff ff       	call   800020 <__panic>
    cprintf("I am the parent, waiting now..\n");
  8010cd:	c7 04 24 04 15 80 00 	movl   $0x801504,(%esp)
  8010d4:	e8 47 f2 ff ff       	call   800320 <cprintf>

    assert(waitpid(pid, &code) == 0 && code == magic);
  8010d9:	8d 44 24 18          	lea    0x18(%esp),%eax
  8010dd:	89 44 24 04          	mov    %eax,0x4(%esp)
  8010e1:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8010e5:	89 04 24             	mov    %eax,(%esp)
  8010e8:	e8 5e f1 ff ff       	call   80024b <waitpid>
  8010ed:	85 c0                	test   %eax,%eax
  8010ef:	75 0d                	jne    8010fe <main+0xd5>
  8010f1:	8b 54 24 18          	mov    0x18(%esp),%edx
  8010f5:	a1 08 20 80 00       	mov    0x802008,%eax
  8010fa:	39 c2                	cmp    %eax,%edx
  8010fc:	74 24                	je     801122 <main+0xf9>
  8010fe:	c7 44 24 0c 24 15 80 	movl   $0x801524,0xc(%esp)
  801105:	00 
  801106:	c7 44 24 08 e2 14 80 	movl   $0x8014e2,0x8(%esp)
  80110d:	00 
  80110e:	c7 44 24 04 1b 00 00 	movl   $0x1b,0x4(%esp)
  801115:	00 
  801116:	c7 04 24 f7 14 80 00 	movl   $0x8014f7,(%esp)
  80111d:	e8 fe ee ff ff       	call   800020 <__panic>
    assert(waitpid(pid, &code) != 0 && wait() != 0);
  801122:	8d 44 24 18          	lea    0x18(%esp),%eax
  801126:	89 44 24 04          	mov    %eax,0x4(%esp)
  80112a:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80112e:	89 04 24             	mov    %eax,(%esp)
  801131:	e8 15 f1 ff ff       	call   80024b <waitpid>
  801136:	85 c0                	test   %eax,%eax
  801138:	74 09                	je     801143 <main+0x11a>
  80113a:	e8 ec f0 ff ff       	call   80022b <wait>
  80113f:	85 c0                	test   %eax,%eax
  801141:	75 24                	jne    801167 <main+0x13e>
  801143:	c7 44 24 0c 50 15 80 	movl   $0x801550,0xc(%esp)
  80114a:	00 
  80114b:	c7 44 24 08 e2 14 80 	movl   $0x8014e2,0x8(%esp)
  801152:	00 
  801153:	c7 44 24 04 1c 00 00 	movl   $0x1c,0x4(%esp)
  80115a:	00 
  80115b:	c7 04 24 f7 14 80 00 	movl   $0x8014f7,(%esp)
  801162:	e8 b9 ee ff ff       	call   800020 <__panic>
    cprintf("waitpid %d ok.\n", pid);
  801167:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80116b:	89 44 24 04          	mov    %eax,0x4(%esp)
  80116f:	c7 04 24 78 15 80 00 	movl   $0x801578,(%esp)
  801176:	e8 a5 f1 ff ff       	call   800320 <cprintf>

    cprintf("exit pass.\n");
  80117b:	c7 04 24 88 15 80 00 	movl   $0x801588,(%esp)
  801182:	e8 99 f1 ff ff       	call   800320 <cprintf>
    return 0;
