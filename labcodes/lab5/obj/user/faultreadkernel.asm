...
main(void) {
  ...
  801036:	b8 00 00 c0 fa       	mov    $0xfac00000,%eax
  80103b:	8b 00                	mov    (%eax),%eax
  80103d:	89 44 24 04          	mov    %eax,0x4(%esp)
  801041:	c7 04 24 60 13 80 00 	movl   $0x801360,(%esp)
  801048:	e8 d3 f2 ff ff       	call   800320 <cprintf>
    panic("FAIL: T.T\n");
  80104d:	c7 44 24 08 7e 13 80 	movl   $0x80137e,0x8(%esp)
  801054:	00 
  801055:	c7 44 24 04 07 00 00 	movl   $0x7,0x4(%esp)
  80105c:	00 
  80105d:	c7 04 24 89 13 80 00 	movl   $0x801389,(%esp)
  801064:	e8 b7 ef ff ff       	call   800020 <__panic>
