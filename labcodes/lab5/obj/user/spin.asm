...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80003e:	c7 04 24 40 11 80 00 	movl   $0x801140,(%esp)
  ...
  800057:	e8 8d 02 00 00       	call   8002e9 <vcprintf>
    cprintf("\n");
  80005c:	c7 04 24 5a 11 80 00 	movl   $0x80115a,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  800092:	c7 04 24 5c 11 80 00 	movl   $0x80115c,(%esp)
  ...
  8000ab:	e8 39 02 00 00       	call   8002e9 <vcprintf>
    cprintf("\n");
  8000b0:	c7 04 24 5a 11 80 00 	movl   $0x80115a,(%esp)
...
exit(int error_code) {
  ...
  80020c:	c7 04 24 78 11 80 00 	movl   $0x801178,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80097a:	05 a4 12 80 00       	add    $0x8012a4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800ada:	8b 04 85 c8 12 80 00 	mov    0x8012c8(,%eax,4),%eax
  ...
  800bdd:	c7 44 24 08 be 12 80 	movl   $0x8012be,0x8(%esp)
  800be4:	00 
  ...
  800c09:	75 05                	jne    800c10 <vprintfmt+0x1a8>
                p = "(null)";
  800c0b:	be c1 12 80 00       	mov    $0x8012c1,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  801036:	c7 04 24 20 14 80 00 	movl   $0x801420,(%esp)
  ...
  801050:	75 0e                	jne    801060 <main+0x37>
        cprintf("I am the child. spinning ...\n");
  801052:	c7 04 24 47 14 80 00 	movl   $0x801447,(%esp)
  801059:	e8 c2 f2 ff ff       	call   800320 <cprintf>
        while (1);
  80105e:	eb fe                	jmp    80105e <main+0x35>
    }
    cprintf("I am the parent. Running the child...\n");
  801060:	c7 04 24 68 14 80 00 	movl   $0x801468,(%esp)
  801067:	e8 b4 f2 ff ff       	call   800320 <cprintf>

    yield();
  80106c:	e8 f8 f1 ff ff       	call   800269 <yield>
    yield();
  801071:	e8 f3 f1 ff ff       	call   800269 <yield>
    yield();
  801076:	e8 ee f1 ff ff       	call   800269 <yield>

    cprintf("I am the parent.  Killing the child...\n");
  80107b:	c7 04 24 90 14 80 00 	movl   $0x801490,(%esp)
  801082:	e8 99 f2 ff ff       	call   800320 <cprintf>

    assert((ret = kill(pid)) == 0);
  801087:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80108b:	89 04 24             	mov    %eax,(%esp)
  80108e:	e8 e8 f1 ff ff       	call   80027b <kill>
  801093:	89 44 24 18          	mov    %eax,0x18(%esp)
  801097:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  80109c:	74 24                	je     8010c2 <main+0x99>
  80109e:	c7 44 24 0c b8 14 80 	movl   $0x8014b8,0xc(%esp)
  8010a5:	00 
  8010a6:	c7 44 24 08 cf 14 80 	movl   $0x8014cf,0x8(%esp)
  8010ad:	00 
  8010ae:	c7 44 24 04 14 00 00 	movl   $0x14,0x4(%esp)
  8010b5:	00 
  8010b6:	c7 04 24 e4 14 80 00 	movl   $0x8014e4,(%esp)
  8010bd:	e8 5e ef ff ff       	call   800020 <__panic>
    cprintf("kill returns %d\n", ret);
  8010c2:	8b 44 24 18          	mov    0x18(%esp),%eax
  8010c6:	89 44 24 04          	mov    %eax,0x4(%esp)
  8010ca:	c7 04 24 f0 14 80 00 	movl   $0x8014f0,(%esp)
  8010d1:	e8 4a f2 ff ff       	call   800320 <cprintf>

    assert((ret = waitpid(pid, NULL)) == 0);
  8010d6:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  8010dd:	00 
  8010de:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  8010e2:	89 04 24             	mov    %eax,(%esp)
  8010e5:	e8 61 f1 ff ff       	call   80024b <waitpid>
  8010ea:	89 44 24 18          	mov    %eax,0x18(%esp)
  8010ee:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  8010f3:	74 24                	je     801119 <main+0xf0>
  8010f5:	c7 44 24 0c 04 15 80 	movl   $0x801504,0xc(%esp)
  8010fc:	00 
  8010fd:	c7 44 24 08 cf 14 80 	movl   $0x8014cf,0x8(%esp)
  801104:	00 
  801105:	c7 44 24 04 17 00 00 	movl   $0x17,0x4(%esp)
  80110c:	00 
  80110d:	c7 04 24 e4 14 80 00 	movl   $0x8014e4,(%esp)
  801114:	e8 07 ef ff ff       	call   800020 <__panic>
    cprintf("wait returns %d\n", ret);
  801119:	8b 44 24 18          	mov    0x18(%esp),%eax
  80111d:	89 44 24 04          	mov    %eax,0x4(%esp)
  801121:	c7 04 24 24 15 80 00 	movl   $0x801524,(%esp)
  801128:	e8 f3 f1 ff ff       	call   800320 <cprintf>

    cprintf("spin may pass.\n");
  80112d:	c7 04 24 35 15 80 00 	movl   $0x801535,(%esp)
  801134:	e8 e7 f1 ff ff       	call   800320 <cprintf>
    return 0;
