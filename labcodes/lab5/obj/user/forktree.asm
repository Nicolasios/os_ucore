...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80003e:	c7 04 24 20 11 80 00 	movl   $0x801120,(%esp)
  ...
  800057:	e8 8d 02 00 00       	call   8002e9 <vcprintf>
    cprintf("\n");
  80005c:	c7 04 24 3a 11 80 00 	movl   $0x80113a,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  800092:	c7 04 24 3c 11 80 00 	movl   $0x80113c,(%esp)
  ...
  8000ab:	e8 39 02 00 00       	call   8002e9 <vcprintf>
    cprintf("\n");
  8000b0:	c7 04 24 3a 11 80 00 	movl   $0x80113a,(%esp)
...
exit(int error_code) {
  ...
  80020c:	c7 04 24 58 11 80 00 	movl   $0x801158,(%esp)
...
umain(void) {
  ...
  8003a4:	83 ec 28             	sub    $0x28,%esp
    int ret = main();
  8003a7:	e8 3e 0d 00 00       	call   8010ea <main>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80097a:	05 84 12 80 00       	add    $0x801284,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800ada:	8b 04 85 a8 12 80 00 	mov    0x8012a8(,%eax,4),%eax
  ...
  800bdd:	c7 44 24 08 9e 12 80 	movl   $0x80129e,0x8(%esp)
  800be4:	00 
  ...
  800c09:	75 05                	jne    800c10 <vprintfmt+0x1a8>
                p = "(null)";
  800c0b:	be a1 12 80 00       	mov    $0x8012a1,%esi
            }
            if (width > 0 && padc != '-') {
...
forkchild(const char *cur, char branch) {
  ...
  801030:	83 ec 48             	sub    $0x48,%esp
  801033:	8b 45 0c             	mov    0xc(%ebp),%eax
  801036:	88 45 e4             	mov    %al,-0x1c(%ebp)
    char nxt[DEPTH + 1];

    if (strlen(cur) >= DEPTH)
  801039:	8b 45 08             	mov    0x8(%ebp),%eax
  80103c:	89 04 24             	mov    %eax,(%esp)
  80103f:	e8 76 f3 ff ff       	call   8003ba <strlen>
  801044:	83 f8 03             	cmp    $0x3,%eax
  801047:	77 4f                	ja     801098 <forkchild+0x6f>
        return;

    snprintf(nxt, DEPTH + 1, "%s%c", cur, branch);
  801049:	0f be 45 e4          	movsbl -0x1c(%ebp),%eax
  80104d:	89 44 24 10          	mov    %eax,0x10(%esp)
  801051:	8b 45 08             	mov    0x8(%ebp),%eax
  801054:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801058:	c7 44 24 08 00 14 80 	movl   $0x801400,0x8(%esp)
  80105f:	00 
  801060:	c7 44 24 04 05 00 00 	movl   $0x5,0x4(%esp)
  801067:	00 
  801068:	8d 45 f3             	lea    -0xd(%ebp),%eax
  80106b:	89 04 24             	mov    %eax,(%esp)
  80106e:	e8 0d fe ff ff       	call   800e80 <snprintf>
    if (fork() == 0) {
  801073:	e8 a2 f1 ff ff       	call   80021a <fork>
  801078:	85 c0                	test   %eax,%eax
  80107a:	75 1d                	jne    801099 <forkchild+0x70>
        forktree(nxt);
  80107c:	8d 45 f3             	lea    -0xd(%ebp),%eax
  80107f:	89 04 24             	mov    %eax,(%esp)
  801082:	e8 14 00 00 00       	call   80109b <forktree>
        yield();
  801087:	e8 dd f1 ff ff       	call   800269 <yield>
        exit(0);
  80108c:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  801093:	e8 5f f1 ff ff       	call   8001f7 <exit>
        return;
  801098:	90                   	nop
    }
}
...
forktree(const char *cur) {
  ...
  8010a2:	83 ec 18             	sub    $0x18,%esp
    cprintf("%04x: I am '%s'\n", getpid(), cur);
  8010a5:	e8 e8 f1 ff ff       	call   800292 <getpid>
  8010aa:	8b 55 08             	mov    0x8(%ebp),%edx
  8010ad:	89 54 24 08          	mov    %edx,0x8(%esp)
  8010b1:	89 44 24 04          	mov    %eax,0x4(%esp)
  8010b5:	c7 04 24 05 14 80 00 	movl   $0x801405,(%esp)
  8010bc:	e8 5f f2 ff ff       	call   800320 <cprintf>
  ...
  8010cf:	e8 55 ff ff ff       	call   801029 <forkchild>
    forkchild(cur, '1');
  8010d4:	c7 44 24 04 31 00 00 	movl   $0x31,0x4(%esp)
  8010db:	00 
  8010dc:	8b 45 08             	mov    0x8(%ebp),%eax
  8010df:	89 04 24             	mov    %eax,(%esp)
  8010e2:	e8 42 ff ff ff       	call   801029 <forkchild>
}
  8010e7:	90                   	nop
  8010e8:	c9                   	leave  
  8010e9:	c3                   	ret    
...
main(void) {
  ...
  8010f1:	83 e4 f0             	and    $0xfffffff0,%esp
  8010f4:	83 ec 10             	sub    $0x10,%esp
    forktree("");
  8010f7:	c7 04 24 16 14 80 00 	movl   $0x801416,(%esp)
  8010fe:	e8 98 ff ff ff       	call   80109b <forktree>
    return 0;
