...
main(void) {
  ...
  80103f:	c7 04 24 60 13 80 00 	movl   $0x801360,(%esp)
  801046:	e8 d5 f2 ff ff       	call   800320 <cprintf>
    print_pgdir();
  80104b:	e8 53 f2 ff ff       	call   8002a3 <print_pgdir>
    cprintf("pgdir pass.\n");
  801050:	c7 04 24 77 13 80 00 	movl   $0x801377,(%esp)
  801057:	e8 c4 f2 ff ff       	call   800320 <cprintf>
    return 0;
