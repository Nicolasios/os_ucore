...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80003e:	c7 04 24 e0 11 80 00 	movl   $0x8011e0,(%esp)
  ...
  800057:	e8 8d 02 00 00       	call   8002e9 <vcprintf>
    cprintf("\n");
  80005c:	c7 04 24 fa 11 80 00 	movl   $0x8011fa,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  800092:	c7 04 24 fc 11 80 00 	movl   $0x8011fc,(%esp)
  ...
  8000ab:	e8 39 02 00 00       	call   8002e9 <vcprintf>
    cprintf("\n");
  8000b0:	c7 04 24 fa 11 80 00 	movl   $0x8011fa,(%esp)
...
exit(int error_code) {
  ...
  80020c:	c7 04 24 18 12 80 00 	movl   $0x801218,(%esp)
...
umain(void) {
  ...
  8003a4:	83 ec 28             	sub    $0x28,%esp
    int ret = main();
  8003a7:	e8 32 0d 00 00       	call   8010de <main>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80097a:	05 44 13 80 00       	add    $0x801344,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800ada:	8b 04 85 68 13 80 00 	mov    0x801368(,%eax,4),%eax
  ...
  800bdd:	c7 44 24 08 5e 13 80 	movl   $0x80135e,0x8(%esp)
  800be4:	00 
  ...
  800c09:	75 05                	jne    800c10 <vprintfmt+0x1a8>
                p = "(null)";
  800c0b:	be 61 13 80 00       	mov    $0x801361,%esi
            }
            if (width > 0 && padc != '-') {
...
do_yield(void) {
  ...
  801030:	83 ec 08             	sub    $0x8,%esp
    yield();
  801033:	e8 31 f2 ff ff       	call   800269 <yield>
    yield();
  801038:	e8 2c f2 ff ff       	call   800269 <yield>
    yield();
  80103d:	e8 27 f2 ff ff       	call   800269 <yield>
    yield();
  801042:	e8 22 f2 ff ff       	call   800269 <yield>
    yield();
  801047:	e8 1d f2 ff ff       	call   800269 <yield>
    yield();
  80104c:	e8 18 f2 ff ff       	call   800269 <yield>
}
  801051:	90                   	nop
  801052:	c9                   	leave  
  801053:	c3                   	ret    
...
loop(void) {
  ...
  80105b:	83 ec 18             	sub    $0x18,%esp
    cprintf("child 1.\n");
  80105e:	c7 04 24 c0 14 80 00 	movl   $0x8014c0,(%esp)
  801065:	e8 b6 f2 ff ff       	call   800320 <cprintf>
    while (1);
  80106a:	eb fe                	jmp    80106a <loop+0x16>
...
work(void) {
  ...
  801073:	83 ec 18             	sub    $0x18,%esp
    cprintf("child 2.\n");
  801076:	c7 04 24 ca 14 80 00 	movl   $0x8014ca,(%esp)
  80107d:	e8 9e f2 ff ff       	call   800320 <cprintf>
    do_yield();
  801082:	e8 a2 ff ff ff       	call   801029 <do_yield>
    if (kill(parent) == 0) {
  801087:	a1 08 20 80 00       	mov    0x802008,%eax
  80108c:	89 04 24             	mov    %eax,(%esp)
  80108f:	e8 e7 f1 ff ff       	call   80027b <kill>
  801094:	85 c0                	test   %eax,%eax
  801096:	75 3a                	jne    8010d2 <work+0x66>
        cprintf("kill parent ok.\n");
  801098:	c7 04 24 d4 14 80 00 	movl   $0x8014d4,(%esp)
  80109f:	e8 7c f2 ff ff       	call   800320 <cprintf>
        do_yield();
  8010a4:	e8 80 ff ff ff       	call   801029 <do_yield>
        if (kill(pid1) == 0) {
  8010a9:	a1 10 20 80 00       	mov    0x802010,%eax
  8010ae:	89 04 24             	mov    %eax,(%esp)
  8010b1:	e8 c5 f1 ff ff       	call   80027b <kill>
  8010b6:	85 c0                	test   %eax,%eax
  8010b8:	75 18                	jne    8010d2 <work+0x66>
            cprintf("kill child1 ok.\n");
  8010ba:	c7 04 24 e5 14 80 00 	movl   $0x8014e5,(%esp)
  8010c1:	e8 5a f2 ff ff       	call   800320 <cprintf>
            exit(0);
  8010c6:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8010cd:	e8 25 f1 ff ff       	call   8001f7 <exit>
        }
    }
    exit(-1);
  8010d2:	c7 04 24 ff ff ff ff 	movl   $0xffffffff,(%esp)
  8010d9:	e8 19 f1 ff ff       	call   8001f7 <exit>
...
main(void) {
  ...
  8010e5:	83 e4 f0             	and    $0xfffffff0,%esp
  8010e8:	83 ec 10             	sub    $0x10,%esp
    parent = getpid();
  8010eb:	e8 a2 f1 ff ff       	call   800292 <getpid>
  8010f0:	a3 08 20 80 00       	mov    %eax,0x802008
    if ((pid1 = fork()) == 0) {
  8010f5:	e8 20 f1 ff ff       	call   80021a <fork>
  8010fa:	a3 10 20 80 00       	mov    %eax,0x802010
  8010ff:	a1 10 20 80 00       	mov    0x802010,%eax
  801104:	85 c0                	test   %eax,%eax
  801106:	75 05                	jne    80110d <main+0x2f>
        loop();
  801108:	e8 47 ff ff ff       	call   801054 <loop>
    }

    assert(pid1 > 0);
  80110d:	a1 10 20 80 00       	mov    0x802010,%eax
  801112:	85 c0                	test   %eax,%eax
  801114:	7f 24                	jg     80113a <main+0x5c>
  801116:	c7 44 24 0c f6 14 80 	movl   $0x8014f6,0xc(%esp)
  80111d:	00 
  80111e:	c7 44 24 08 ff 14 80 	movl   $0x8014ff,0x8(%esp)
  801125:	00 
  801126:	c7 44 24 04 2c 00 00 	movl   $0x2c,0x4(%esp)
  80112d:	00 
  80112e:	c7 04 24 14 15 80 00 	movl   $0x801514,(%esp)
  801135:	e8 e6 ee ff ff       	call   800020 <__panic>

    if ((pid2 = fork()) == 0) {
  80113a:	e8 db f0 ff ff       	call   80021a <fork>
  80113f:	a3 0c 20 80 00       	mov    %eax,0x80200c
  801144:	a1 0c 20 80 00       	mov    0x80200c,%eax
  801149:	85 c0                	test   %eax,%eax
  80114b:	75 05                	jne    801152 <main+0x74>
        work();
  80114d:	e8 1a ff ff ff       	call   80106c <work>
    }
    if (pid2 > 0) {
  801152:	a1 0c 20 80 00       	mov    0x80200c,%eax
  801157:	85 c0                	test   %eax,%eax
  801159:	7e 46                	jle    8011a1 <main+0xc3>
        cprintf("wait child 1.\n");
  80115b:	c7 04 24 24 15 80 00 	movl   $0x801524,(%esp)
  801162:	e8 b9 f1 ff ff       	call   800320 <cprintf>
        waitpid(pid1, NULL);
  801167:	a1 10 20 80 00       	mov    0x802010,%eax
  80116c:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  801173:	00 
  801174:	89 04 24             	mov    %eax,(%esp)
  801177:	e8 cf f0 ff ff       	call   80024b <waitpid>
        panic("waitpid %d returns\n", pid1);
  80117c:	a1 10 20 80 00       	mov    0x802010,%eax
  801181:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801185:	c7 44 24 08 33 15 80 	movl   $0x801533,0x8(%esp)
  80118c:	00 
  80118d:	c7 44 24 04 34 00 00 	movl   $0x34,0x4(%esp)
  801194:	00 
  801195:	c7 04 24 14 15 80 00 	movl   $0x801514,(%esp)
  80119c:	e8 7f ee ff ff       	call   800020 <__panic>
    }
    else {
        kill(pid1);
  8011a1:	a1 10 20 80 00       	mov    0x802010,%eax
  8011a6:	89 04 24             	mov    %eax,(%esp)
  8011a9:	e8 cd f0 ff ff       	call   80027b <kill>
    }
    panic("FAIL: T.T\n");
  8011ae:	c7 44 24 08 47 15 80 	movl   $0x801547,0x8(%esp)
  8011b5:	00 
  8011b6:	c7 44 24 04 39 00 00 	movl   $0x39,0x4(%esp)
  8011bd:	00 
  8011be:	c7 04 24 14 15 80 00 	movl   $0x801514,(%esp)
  8011c5:	e8 56 ee ff ff       	call   800020 <__panic>
