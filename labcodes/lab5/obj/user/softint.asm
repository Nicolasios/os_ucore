...
main(void) {
  ...
  801033:	83 ec 10             	sub    $0x10,%esp
    asm volatile("int $14");
  801036:	cd 0e                	int    $0xe
    panic("FAIL: T.T\n");
  801038:	c7 44 24 08 40 13 80 	movl   $0x801340,0x8(%esp)
  80103f:	00 
  801040:	c7 44 24 04 07 00 00 	movl   $0x7,0x4(%esp)
  801047:	00 
  801048:	c7 04 24 4b 13 80 00 	movl   $0x80134b,(%esp)
  80104f:	e8 cc ef ff ff       	call   800020 <__panic>
