...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80003e:	c7 04 24 c0 10 80 00 	movl   $0x8010c0,(%esp)
  ...
  800057:	e8 8d 02 00 00       	call   8002e9 <vcprintf>
    cprintf("\n");
  80005c:	c7 04 24 da 10 80 00 	movl   $0x8010da,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  800092:	c7 04 24 dc 10 80 00 	movl   $0x8010dc,(%esp)
  ...
  8000ab:	e8 39 02 00 00       	call   8002e9 <vcprintf>
    cprintf("\n");
  8000b0:	c7 04 24 da 10 80 00 	movl   $0x8010da,(%esp)
...
exit(int error_code) {
  ...
  80020c:	c7 04 24 f8 10 80 00 	movl   $0x8010f8,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80097a:	05 24 12 80 00       	add    $0x801224,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800ada:	8b 04 85 48 12 80 00 	mov    0x801248(,%eax,4),%eax
  ...
  800bdd:	c7 44 24 08 3e 12 80 	movl   $0x80123e,0x8(%esp)
  800be4:	00 
  ...
  800c09:	75 05                	jne    800c10 <vprintfmt+0x1a8>
                p = "(null)";
  800c0b:	be 41 12 80 00       	mov    $0x801241,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  801036:	e8 57 f2 ff ff       	call   800292 <getpid>
  80103b:	89 44 24 04          	mov    %eax,0x4(%esp)
  80103f:	c7 04 24 a0 13 80 00 	movl   $0x8013a0,(%esp)
  801046:	e8 d5 f2 ff ff       	call   800320 <cprintf>
    for (i = 0; i < 5; i ++) {
  80104b:	c7 44 24 1c 00 00 00 	movl   $0x0,0x1c(%esp)
  801052:	00 
  801053:	eb 26                	jmp    80107b <main+0x52>
        yield();
  801055:	e8 0f f2 ff ff       	call   800269 <yield>
        cprintf("Back in process %d, iteration %d.\n", getpid(), i);
  80105a:	e8 33 f2 ff ff       	call   800292 <getpid>
  80105f:	8b 54 24 1c          	mov    0x1c(%esp),%edx
  801063:	89 54 24 08          	mov    %edx,0x8(%esp)
  801067:	89 44 24 04          	mov    %eax,0x4(%esp)
  80106b:	c7 04 24 bc 13 80 00 	movl   $0x8013bc,(%esp)
  801072:	e8 a9 f2 ff ff       	call   800320 <cprintf>
    for (i = 0; i < 5; i ++) {
  801077:	ff 44 24 1c          	incl   0x1c(%esp)
  80107b:	83 7c 24 1c 04       	cmpl   $0x4,0x1c(%esp)
  801080:	7e d3                	jle    801055 <main+0x2c>
    }
    cprintf("All done in process %d.\n", getpid());
  801082:	e8 0b f2 ff ff       	call   800292 <getpid>
  801087:	89 44 24 04          	mov    %eax,0x4(%esp)
  80108b:	c7 04 24 df 13 80 00 	movl   $0x8013df,(%esp)
  801092:	e8 89 f2 ff ff       	call   800320 <cprintf>
    cprintf("yield pass.\n");
  801097:	c7 04 24 f8 13 80 00 	movl   $0x8013f8,(%esp)
  80109e:	e8 7d f2 ff ff       	call   800320 <cprintf>
    return 0;
