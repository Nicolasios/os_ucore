...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80003e:	c7 04 24 60 10 80 00 	movl   $0x801060,(%esp)
  ...
  800057:	e8 8d 02 00 00       	call   8002e9 <vcprintf>
    cprintf("\n");
  80005c:	c7 04 24 7a 10 80 00 	movl   $0x80107a,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  800092:	c7 04 24 7c 10 80 00 	movl   $0x80107c,(%esp)
  ...
  8000ab:	e8 39 02 00 00       	call   8002e9 <vcprintf>
    cprintf("\n");
  8000b0:	c7 04 24 7a 10 80 00 	movl   $0x80107a,(%esp)
...
exit(int error_code) {
  ...
  80020c:	c7 04 24 98 10 80 00 	movl   $0x801098,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80097a:	05 c4 11 80 00       	add    $0x8011c4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800ada:	8b 04 85 e8 11 80 00 	mov    0x8011e8(,%eax,4),%eax
  ...
  800bdd:	c7 44 24 08 de 11 80 	movl   $0x8011de,0x8(%esp)
  800be4:	00 
  ...
  800c09:	75 05                	jne    800c10 <vprintfmt+0x1a8>
                p = "(null)";
  800c0b:	be e1 11 80 00       	mov    $0x8011e1,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  801036:	66 b8 28 00          	mov    $0x28,%ax
  80103a:	8e d8                	mov    %eax,%ds
    panic("FAIL: T.T\n");
  80103c:	c7 44 24 08 40 13 80 	movl   $0x801340,0x8(%esp)
  801043:	00 
  801044:	c7 44 24 04 09 00 00 	movl   $0x9,0x4(%esp)
  80104b:	00 
  80104c:	c7 04 24 4b 13 80 00 	movl   $0x80134b,(%esp)
  801053:	e8 c8 ef ff ff       	call   800020 <__panic>
