...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80003e:	c7 04 24 80 10 80 00 	movl   $0x801080,(%esp)
  ...
  800057:	e8 8d 02 00 00       	call   8002e9 <vcprintf>
    cprintf("\n");
  80005c:	c7 04 24 9a 10 80 00 	movl   $0x80109a,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  800092:	c7 04 24 9c 10 80 00 	movl   $0x80109c,(%esp)
  ...
  8000ab:	e8 39 02 00 00       	call   8002e9 <vcprintf>
    cprintf("\n");
  8000b0:	c7 04 24 9a 10 80 00 	movl   $0x80109a,(%esp)
...
exit(int error_code) {
  ...
  80020c:	c7 04 24 b8 10 80 00 	movl   $0x8010b8,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80097a:	05 e4 11 80 00       	add    $0x8011e4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800ada:	8b 04 85 08 12 80 00 	mov    0x801208(,%eax,4),%eax
  ...
  800bdd:	c7 44 24 08 fe 11 80 	movl   $0x8011fe,0x8(%esp)
  800be4:	00 
  ...
  800c09:	75 05                	jne    800c10 <vprintfmt+0x1a8>
                p = "(null)";
  800c0b:	be 01 12 80 00       	mov    $0x801201,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  801033:	83 ec 10             	sub    $0x10,%esp
    cprintf("value is %d.\n", 1 / zero);
  801036:	8b 0d 08 20 80 00    	mov    0x802008,%ecx
  80103c:	b8 01 00 00 00       	mov    $0x1,%eax
  801041:	99                   	cltd   
  801042:	f7 f9                	idiv   %ecx
  801044:	89 44 24 04          	mov    %eax,0x4(%esp)
  801048:	c7 04 24 60 13 80 00 	movl   $0x801360,(%esp)
  80104f:	e8 cc f2 ff ff       	call   800320 <cprintf>
    panic("FAIL: T.T\n");
  801054:	c7 44 24 08 6e 13 80 	movl   $0x80136e,0x8(%esp)
  80105b:	00 
  80105c:	c7 44 24 04 09 00 00 	movl   $0x9,0x4(%esp)
  801063:	00 
  801064:	c7 04 24 79 13 80 00 	movl   $0x801379,(%esp)
  80106b:	e8 b0 ef ff ff       	call   800020 <__panic>
