...
main(void) {
  ...
  801033:	83 ec 10             	sub    $0x10,%esp
    cprintf("Hello world!!.\n");
  801036:	c7 04 24 60 13 80 00 	movl   $0x801360,(%esp)
  80103d:	e8 de f2 ff ff       	call   800320 <cprintf>
    cprintf("I am process %d.\n", getpid());
  801042:	e8 4b f2 ff ff       	call   800292 <getpid>
  801047:	89 44 24 04          	mov    %eax,0x4(%esp)
  80104b:	c7 04 24 70 13 80 00 	movl   $0x801370,(%esp)
  801052:	e8 c9 f2 ff ff       	call   800320 <cprintf>
    cprintf("hello pass.\n");
  801057:	c7 04 24 82 13 80 00 	movl   $0x801382,(%esp)
  80105e:	e8 bd f2 ff ff       	call   800320 <cprintf>
    return 0;
